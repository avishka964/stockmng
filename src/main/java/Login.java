...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        login.setBackground(new java.awt.Color(24, 119, 232));
        ...
        cancel.setBackground(new java.awt.Color(24, 119, 232));
        ...
        jPanel3.setBackground(new java.awt.Color(48, 202, 182));
    ...
    private void loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginMouseClicked
        String Query = "select * from stockmng.User where userName='"+userName.getText()+"' and password = '"+password.getText()+"'";
        try{
